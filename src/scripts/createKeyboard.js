export default function createKeyboard() {
  ...
  <button class="keyboard__btn" data-code="Digit2">
    2
    <span class="keyboard__btn__additional-char" data-lang="eng">@</span>
    <span class="keyboard__btn__additional-char" data-lang="rus">"</span>
  </button>
  ...
  <button class="keyboard__btn" data-code="Equal">
    =
    <span class="keyboard__btn__additional-char" data-code="Plus">+</span>
  </button>
  ...
  <button class="keyboard__btn" data-code="KeyZ">
  <span data-lang="eng">Z</span>
  <span data-lang="rus">Я</span>
</button>
  <button class="keyboard__btn" data-code="KeyX">
  <span data-lang="eng">X</span>
  <span data-lang="rus">Ч</span>
</button>
  <button class="keyboard__btn" data-code="KeyC">
  <span data-lang="eng">С</span>
  <span data-lang="rus">C</span>
</button>
  <button class="keyboard__btn" data-code="KeyV">
  <span data-lang="eng">V</span>
  <span data-lang="rus">М</span>
</button>
  <button class="keyboard__btn" data-code="KeyB">
  <span data-lang="eng">B</span>
  <span data-lang="rus">И</span>
</button>
  <button class="keyboard__btn" data-code="KeyN">
  <span data-lang="eng">N</span>
  <span data-lang="rus">Т</span>
</button>
  <button class="keyboard__btn" data-code="KeyM">
  <span data-lang="eng">M</span>
  <span data-lang="rus">Ь</span>
</button>
  <button class="keyboard__btn" data-code="Comma">
  <span data-lang="eng">,</span>
  <span data-lang="rus">Б</span>
</button>
  <button class="keyboard__btn" data-code="Period">
  <span data-lang="eng">.</span>
  <span data-lang="rus">Ю</span>
</button>
  <button class="keyboard__btn" data-code="Slash">
  <span data-lang="eng">/</span>
